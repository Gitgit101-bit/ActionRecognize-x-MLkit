...
public class MainActivity extends AppCompatActivity {
    ...
    private int dumbbell = 101;
    //private int dumbbell2 = 102;
    private int pushup = 103;
    //private int pushup2 = 104;
    ...
    //private String PushUpJsonData2 = null;
    private String DumbbellJsonData = null;
    //private String DumbbellJsonData2 = null;
    private int flag = pushup;
    ...
    private void onImageResponse(int poseId, int score, int width, int height, Bitmap bmp) {
        ...
        checkPose(flag, false);
    }

    private void setScoreText(int poseId, int score) {
        if (score == 1 && lastposescore != 1) {
            lastposescore = 1;
            count++ ;
        ...
        switch (score) {
            case 1:
                mTvPoseScore.setText("Match: "+score);
                break;
            case 0:
            case -1:
            default:
                mTvPoseScore.setText("Score : " + String.valueOf(score));
                lastposescore = 0;
                break;
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DumbbellJsonData = LoadJsonFromAsset("Dumbbell");
        Log.d("PushUpJsonData",PushUpJsonData);
        Log.d("DumbbellJsonData",DumbbellJsonData);
    }
    ...
    protected void onPostCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBtnPreviewSwitcher.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (previewOn) {
                    ...
                    count = 0;
                    mBtnChangeMode.setVisibility(View.INVISIBLE);
                    time = 0.0;
                    timerTask.cancel();
                    ...
                    mBtnChangeMode.setVisibility(View.VISIBLE);
        ...
        mBtnChangeMode = this.findViewById(R.id.btnChangeMode);
        mBtnChangeMode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (flag == pushup){
                    mBtnChangeMode.setText("Dumbbell to PushUp");
                    flag = dumbbell;
                    countview.setText("Count: 0");
                    count = 0;
                    Log.d("change"," mode");
                    ...
                    flag = pushup;
                    mBtnChangeMode.setText("PushUp to Dumbbell");
                    countview.setText("Count: 0");
                    count = 0;
                    Log.d("change"," mode");
                }
        ...
        this.findViewById(R.id.btnLoadImage).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                uploadActionResource("image/*", "Choose a skeleton picture", PICK_ACTION_SKELETON_PIC_RESULT_CODE);
            }
        });
    }
